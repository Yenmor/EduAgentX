# EduAgentX v1.3.1 Release Notes
...
- **Selected KB is now trusted system state** - chat RAG calls no longer let the
  LLM invent or override `kb_name`; the model only sees a `query`, and EduAgentX
...
- **Embedding responses are validated before use** - EduAgentX now rejects
...
**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v1.3.0...v1.3.1
