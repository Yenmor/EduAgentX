# EduAgentX v1.4.0 Release Notes
...
docs at [eduagentx.local](https://eduagentx.local).
...
- `.gitignore` covers `.playwright-cli/`; stale `.playwright-cli/`
  captures, `.env.example_CN`, and `EduAgentX.code-workspace` removed.
...
**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v1.4.0-beta...v1.4.0
