# EduAgentX v1.3.2 Release Notes
...
Embedding configuration is now explicit about the exact URL EduAgentX will call.
...
- **Settings now shows Endpoint URL for embeddings** - the Web settings page
  labels embedding URLs as endpoint URLs and explains that EduAgentX posts to
...
**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v1.3.1...v1.3.2
