# EduAgentX v0.5.0 Release Notes

**Release Date:** 2026.01.15

We're thrilled to announce EduAgentX v0.5.0! This release delivers **unified service configuration**, **flexible RAG pipeline selection**, and **major UI/UX improvements** across multiple modules.
...
> [!TIP]
> **Call for Issues:** We welcome your feedback! If you encounter any bugs or have feature requests, please [open an issue](https://github.com/HKUDS/EduAgentX/issues)! If you would like to submit a PR, please check out our [Contributing Guide](https://github.com/HKUDS/EduAgentX/blob/main/CONTRIBUTING.md).
...
* feat(kb): allow selecting RAG provider during KB create/upload by @tusharkhatriofficial in https://github.com/HKUDS/EduAgentX/pull/129
* fix(docker): make Dockerfile portable by @scrrlt in https://github.com/HKUDS/EduAgentX/pull/128
* feat: pre-commit CI integration by @scrrlt in https://github.com/HKUDS/EduAgentX/pull/126
* feat: LlamaIndex pipeline implementation by @tusharkhatriofficial in https://github.com/HKUDS/EduAgentX/pull/98
* feat: web search providers (Tavily, Exa, Jina, Serper) by @Andres77872 in https://github.com/HKUDS/EduAgentX/pull/95
* feat: Azure OpenAI support enhancement by @scrrlt in https://github.com/HKUDS/EduAgentX/pull/87
* fix: modal vertical centering by @OlalalalaO in https://github.com/HKUDS/EduAgentX/pull/117
* work: LLM error framework by @scrrlt in https://github.com/HKUDS/EduAgentX/pull/118

## New Contributors

* @Andres77872 made their first contribution in https://github.com/HKUDS/EduAgentX/pull/95
* @OlalalalaO made their first contribution in https://github.com/HKUDS/EduAgentX/pull/117

**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v0.4.1...v0.5.0
