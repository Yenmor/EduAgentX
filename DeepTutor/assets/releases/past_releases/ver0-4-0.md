# 🚀 EduAgentX v0.4.0 Release Notes

**Release Date:** 2026.01.09

We're excited to announce EduAgentX v0.4.0! This release brings **New home page**, **Expanded provider support for LLM & Embeddings provider**, **RAG module decoupling**, **Web improvement**, and a bunch of minor improvements.

> 🚧 **Possible Issues:** Docker deployment and local LLM/Embeddings setup (Ollama, LM Studio) may still have compatibility issues. We're actively working on improvements. **Issues and PRs are welcome!** → [Open an Issue](https://github.com/HKUDS/EduAgentX/issues) | [Contributing Guide](https://github.com/HKUDS/EduAgentX/blob/main/CONTRIBUTING.md)
...
> 💡 **Remote Access:** If accessing EduAgentX from another device on your network, set `NEXT_PUBLIC_API_BASE` to your server's IP. If not set, defaults to `http://localhost:8001` (local machine only).
...
## What's Changed
* chore(deps): bump actions/checkout from 4 to 6 by @dependabot in https://github.com/HKUDS/EduAgentX/pull/39
* chore(deps): bump actions/configure-pages from 4 to 5 by @dependabot in https://github.com/HKUDS/EduAgentX/pull/40
* chore(deps): bump lucide-react from 0.460.0 to 0.562.0 in /web by @dependabot in https://github.com/HKUDS/EduAgentX/pull/43
* chore(deps): bump react-markdown from 9.1.0 to 10.1.0 in /web by @dependabot in https://github.com/HKUDS/EduAgentX/pull/47
* chore(deps): bump node from 20-slim to 25-slim by @dependabot in https://github.com/HKUDS/EduAgentX/pull/42
* chore(deps): bump actions/upload-pages-artifact from 3 to 4 by @dependabot in https://github.com/HKUDS/EduAgentX/pull/38
* chore(deps): bump framer-motion from 11.18.2 to 12.24.0 in /web by @dependabot in https://github.com/HKUDS/EduAgentX/pull/44
* chore(deps): bump tailwind-merge from 2.6.0 to 3.4.0 in /web by @dependabot in https://github.com/HKUDS/EduAgentX/pull/45
* chore(deps): bump @types/node from 22.19.3 to 25.0.3 in /web by @dependabot in https://github.com/HKUDS/EduAgentX/pull/48
* fix(ci): Resolve linting and formatting issues by @ahmedjawedaj in https://github.com/HKUDS/EduAgentX/pull/50
* Feature/rag plugin system by @tusharkhatriofficial in https://github.com/HKUDS/EduAgentX/pull/57
* fix: resolve double decoration in embedding functions for OpenRouter by @Laksh-star in https://github.com/HKUDS/EduAgentX/pull/64
* Fix critical jspdf vuln and clean up pre-commit hooks by @RinZ27 in https://github.com/HKUDS/EduAgentX/pull/62
* UI/theme by @tusharkhatriofficial in https://github.com/HKUDS/EduAgentX/pull/51
* feat: support baidu ai search by @yugasun in https://github.com/HKUDS/EduAgentX/pull/55
* Cleanup: address reviewer feedback on PR #62 (Final) by @RinZ27 in https://github.com/HKUDS/EduAgentX/pull/67
* provides more llm providers supports, UI updates by @kushalgarg101 in https://github.com/HKUDS/EduAgentX/pull/77
* Dev embeddings providers by @FacundoMajda in https://github.com/HKUDS/EduAgentX/pull/79

## 🤝 New Contributors
* @dependabot made their first contribution in https://github.com/HKUDS/EduAgentX/pull/39
* @Laksh-star made their first contribution in https://github.com/HKUDS/EduAgentX/pull/64
* @yugasun made their first contribution in https://github.com/HKUDS/EduAgentX/pull/55
* @kushalgarg101 made their first contribution in https://github.com/HKUDS/EduAgentX/pull/77
* @FacundoMajda made their first contribution in https://github.com/HKUDS/EduAgentX/pull/79

**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v0.3.0...v0.4.0
