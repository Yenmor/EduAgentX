# 🚀 EduAgentX v0.3.0 Release Notes

**Release Date:** January 6, 2026

We're excited to announce EduAgentX v0.3.0! This release focuses on **developer experience improvements**, **CI/CD automation**, and **simplified local deployment**.
...
This aligns with EduAgentX's vision for privacy-first, self-hosted AI tutoring.
...
## What's Changed
* fix(UI): unrendered markdown in ActivityDetail card by @tusharkhatriofficial in https://github.com/HKUDS/EduAgentX/pull/26
* chore: transtale readme to ru by @oshliaer in https://github.com/HKUDS/EduAgentX/pull/27
* fix: improve reload_excludes configuration for uvicorn server and added support for newer models (openai) by @LouisACR in https://github.com/HKUDS/EduAgentX/pull/28
* feat: Dynamic LLM Provider Support (Local & Cloud) by @ahmedjawedaj in https://github.com/HKUDS/EduAgentX/pull/34

## 🤝New Contributors
* @oshliaer made their first contribution in https://github.com/HKUDS/EduAgentX/pull/27
* @LouisACR made their first contribution in https://github.com/HKUDS/EduAgentX/pull/28
* @ahmedjawedaj made their first contribution in https://github.com/HKUDS/EduAgentX/pull/34
