# EduAgentX v1.4.7 Release Notes

**Release Date:** 2026.06.18

A focused release on top of [v1.4.6](ver1-4-6.md): your local coding agents
become something EduAgentX can talk to. Connect **Claude Code** or **Codex**
...
> or Codex CLI already installed on the machine running EduAgentX — nothing is
...
- EduAgentX detects an installed **Claude Code** or **Codex** and connects it as
...
- Connected Agents require the Claude Code and/or Codex CLI installed on the
  host running EduAgentX — they are detected, never installed for you.
- The docs at [eduagentx.local](https://eduagentx.local/) are still catching up to
  the recent releases and will be refreshed shortly.

**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v1.4.6...v1.4.7
