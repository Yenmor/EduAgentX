# EduAgentX v1.3.5 Release Notes
...
- **Embedding examples are easier to follow** - English and Chinese sample env
  files now explain that `EMBEDDING_HOST` is the exact endpoint EduAgentX calls.
...
**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v1.3.4...v1.3.5
