# EduAgentX v1.3.7 Release Notes
...
- Set `LLM_REASONING_EFFORT` in `.env` if you need global thinking control.
  Leave it empty to let EduAgentX auto-detect behavior from the active model.
...
**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v1.3.6...v1.3.7
