# EduAgentX v1.2.2 Release Notes
...
- **`/api/version` route** — a Next.js ISR endpoint that queries `api.github.com/repos/HKUDS/EduAgentX/releases/latest` (hourly revalidation, optional `GITHUB_TOKEN` for rate-limit headroom) and returns the latest tag, name, URL, and publish date.
...
**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v1.2.1...v1.2.2
