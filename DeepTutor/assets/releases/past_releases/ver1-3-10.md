# EduAgentX v1.3.10 Release Notes
...
- **Remote single-user Docker works out of the box again** - when
  `AUTH_ENABLED=false`, EduAgentX now accepts browser origins over HTTP/HTTPS so
...
**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v1.3.9...v1.3.10
