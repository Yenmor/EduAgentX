# EduAgentX v1.2.4 Release Notes
...
- **Dependency installation step** — the tour checks Python, `uv`, Node.js, and npm; installs backend requirements, installs EduAgentX in editable mode, and runs frontend `npm install` with live terminal output.
...
**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v1.2.3...v1.2.4
