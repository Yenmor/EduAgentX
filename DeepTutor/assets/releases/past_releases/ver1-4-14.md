# EduAgentX v1.4.14 Release Notes
...
LightRAG indexing hard-failed with "Parser 'mineru' is not properly installed" even when you'd picked a different parsing engine, because RAG-Anything ran a one-time install check on its default parser. EduAgentX already feeds it pre-parsed content, so that spurious check is now skipped and indexing proceeds regardless of which parse engine you chose (issue #594).
...
**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v1.4.13...v1.4.14
