# EduAgentX v1.4.8 Release Notes
...
Codex, select it in chat, and EduAgentX consults it live — its persona, library
...
EduAgentX chat threads into a single partner session, archived in that partner's
...
A partner conversation can now be pulled into a EduAgentX chat as a referenced
...
**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v1.4.7...v1.4.8
