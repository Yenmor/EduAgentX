# EduAgentX v1.3.9 Release Notes
...
- **Minimal thinking mode is provider-safe** - DeepSeek, DashScope, VolcEngine,
  ...
  `reasoning_effort=minimal`; EduAgentX sends the provider-specific disable
  signal instead.
...
**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v1.3.8...v1.3.9
