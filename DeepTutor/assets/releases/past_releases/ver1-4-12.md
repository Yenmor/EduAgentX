# EduAgentX v1.4.12 Release Notes
...
EduAgentX offloads retrieval to it over HTTP — no local index is built. Each KB
...
**Full Changelog**: https://github.com/HKUDS/EduAgentX/compare/v1.4.11...v1.4.12
