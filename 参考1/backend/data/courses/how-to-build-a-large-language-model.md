...
course_name: 大语言模型基础
level: 高级模型层
source_file: how-to-build-a-large-language-model.md
...
学习语言模型、Tokenization、Transformer、预训练、微调、Prompt Engineering 与 LLM 应用基础。

## 先修课程

Transformer 架构基础, PyTorch 深度学习实践

## 后续课程

RAG 检索增强生成, RAG 与 LangChain 应用开发, AI Agent 与多智能体系统
