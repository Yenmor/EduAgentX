---
course_id: langchain
course_name: RAG 与 LangChain 应用开发
level: LLM 应用层
source_file: langchain-production-llm.md
...
学习 LCEL、Retriever、Memory、Tool、Callback、Observability 与生产级 LLM 应用架构。

## 先修课程

Python 程序设计, 大语言模型基础, RAG 检索增强生成
...
## 原始内容：LangChain 表达式语言 (LCEL) 内部机制
